...
public static void printReceipt(RentalData rental) {
    SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
    Car car = getCarById(rental.carId);
    
    System.out.println("==================================== STRUK SEWA MOBIL ====================================");
    System.out.println("Rental Mobil 545");
    System.out.println("Tanggal: " + sdf.format(new Date()));
    System.out.println("Nama Pelanggan: " + rental.nama);
    System.out.println("NIK: " + rental.nik);
    System.out.println("Mobil yang Disewa: " + (car != null ? car.namaMobil : "Unknown"));
    System.out.println("Tujuan: " + rental.tujuan);
    System.out.println("Tanggal Berangkat: " + sdf.format(rental.jadwalBerangkat));
    System.out.println("Tanggal Kembali: " + sdf.format(rental.jadwalKembali));
    System.out.println("Biaya: Rp " + String.format("%,.0f", rental.totalBiaya));
    System.out.println("========================================================================================");
    System.out.println("Terima kasih telah menyewa mobil di Rental Mobil 545!");
    System.out.println("=============================================================================");
}
...
public static void insertRent() throws IOException, ParseException {
    ...
    while(continueCustomer) {
        ...
        while(continueRental && !cars.isEmpty()) {
            ...
            if(carIndex >= 0 && carIndex < cars.size()) {
                ...
                RentalData rental = new RentalData(rentalId, selectedCar.id, nik, nama, useSupir, 
                ...
                // Cetak struk
                printReceipt(rental); // Menambahkan struk penyewaan
    ...
    private static void initializeSampleData() {
        cars.add(new Car(1, "Calya", 400000, false));
        cars.add(new Car(2, "Expander", 460000, false));
        ...
        cars.add(new Car(6, "Izusu Phanter Turbo", 600000, true));
        //tambah
    }
...
//        initializeSampleRentalData();
        ...
        System.out.println("24.240.0054 ");
        System.out.println("Shashi risqi maulana ");
        showMenu();
        int choice;
